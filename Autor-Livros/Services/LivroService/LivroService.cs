...
namespace Autor_Livros.Services.LivroService
{
    public class LivroService : ILivroInterface
    {
        ...
        public async Task<ResponseModel<LivroModel>> BuscaLivroPorId(int idLivro)
        {
        ...
        public async Task<ResponseModel<List<LivroModel>>> CriarLivro(LivroCriacaoDto livroCricaoDto)
        {
            ResponseModel<List<LivroModel>> resposta = new ResponseModel<List<LivroModel>>();
            try
            {
                var autor = await _context.Autores
                    .FirstOrDefaultAsync(autorBanco => autorBanco.Id == livroCricaoDto.Autor.Id);
        ...
        public async Task<ResponseModel<List<LivroModel>>> ListarLivros()
        {
            ...
            try
            {
                ...
                resposta.Mensagem = "Livros coletados.";
                return resposta;
